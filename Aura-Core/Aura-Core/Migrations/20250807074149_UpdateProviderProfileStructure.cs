    ...
    public partial class UpdateProviderProfileStructure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderUserDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProviderUserDetails_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalSchema: "aura",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegularUserDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegularUserDetails_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalSchema: "aura",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_ProviderUserDetails_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_ProviderUserDetails_ProviderId",
                        column: x => x.ProviderId,
                        principalSchema: "aura",
                        principalTable: "ProviderUserDetails",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegularUserDetails_UserId",
                schema: "aura",
